...
int main () {
    ...
    for (uint32_t curOp = 0; curOp < opAmount; curOp++) {
        ...
        case 2: {
            ...
            if ((heapsArr[idxArr[elemIdx].heapNum]->next != NULL) || (heapsArr[idxArr[elemIdx].heapNum]->degree != 0)) {
                result = deleteElem(heapsArr[idxArr[elemIdx].heapNum], idxArr[elemIdx].elem, idxArr, heapsArr);
            ...
            heapsArr[idxArr[elemIdx].heapNum] = result;
        ...
        case 3: {
            ...
            if (heapsArr[idxArr[elemIdx].heapNum] == NULL)
                abort();
            break;
        }
        case 4: {
        ...
        case 5: {
            ...
            node* result  = NULL;
            if ((heapsArr[heapNum]->next == NULL) && (heapsArr[heapNum]->degree == 0)) {
                result = extractNode(heapsArr[heapNum], findMin(heapsArr[heapNum]));
